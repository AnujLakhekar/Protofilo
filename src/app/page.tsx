        ...
        <div
            ...
            >
                <div>
                    ...
                    <p className="mt-2 md:mt-4 max-w-xs text-slate-400">I build accessible, pixel-perfect digital
                        ...
                        <div className="flex flex-col gap-4">
                            {pages.map((page) => (
                                ...
                                >
                                    ...
                                    />
                                    <span
                                        className="text-xs font-bold tracking-widest uppercase group-hover:text-yellow-500">{page}</span>
                                </a>
                            ))}
                        </div>
                    </div>
                ...
                <div
                    className="mt-8 m-2 flex flex-col sm:flex-row bg-white/10 border-2 border-white/15 justify-center p-2 rounded-lg items-center gap-6">
            ...
            {/* RIGHT CONTENT */}
            <div
                className="w-full max-w-3xl md:ml-[28rem] h-auto md:h-screen overflow-y-auto scroll-smooth rightpannel snap-y snap-mandatory mt-8 md:mt-0">
